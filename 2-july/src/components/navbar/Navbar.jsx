...
const Navbar = () => {
  return (
    <>
      <nav className="text-slate-200 flex items-center justify-between px-40 py-6 sticky">
        <div className="left text-sm flex gap-7 items-center">
          <a href="">
            <img
        ...
        <div className="right text-xs flex items-center gap-4 text-[#ced4da]">
          ...
          <a href="">
            <button className="border-[.5px] border-[#ced4da] px-2 py-1 rounded shadow-inner  ">
              Sign in
            </button>
          </a>
          <a href="">
            <button className="border-[1px] border-[#52b788] px-2 py-1 rounded bg-green-800 shadow-inner ">
              Start your project
            </button>
          </a>
        </div>
      </nav>
      <div className="w-[100vw] h-[.5px] bg-gray-600"></div>
    </>
  );
};
